...
import PopulationGraphHighCharts from './PopulationGraphHighCharts'
...
const meta: Meta<typeof PopulationGraphHighCharts> = {
  title: 'Components/PopulationGraphHighCharts',
  component: PopulationGraphHighCharts,
  tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
        component: '都道府県の人口推移を表示するグラフコンポーネント（Highcharts版）',
      },
    },
  },
}
...
export default meta
type Story = StoryObj<typeof PopulationGraphHighCharts>
